...
function Hero() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6 text-center">
      <Badge className="mx-auto bg-slate-200 dark:bg-slate-900 text-xs text-slate-700 dark:text-slate-300">
      ...
      <div className="space-y-3">
        ...
        <p className="text-balance text-sm text-slate-600 dark:text-slate-400 sm:text-base">
      ...
      <div className="mx-auto flex w-full max-w-xl flex-col gap-3">
        <div className="flex items-center gap-2 rounded-full border border-slate-300 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-950/80 px-3 py-1.5 shadow-lg shadow-slate-900/10 dark:shadow-slate-950/60">
          <Search className="ml-1 h-4 w-4 text-slate-500 dark:text-slate-500" />
          <input
            type="text"
            placeholder="Pozisyon, teknoloji veya şirket ara..."
            className="h-9 flex-1 border-0 bg-transparent text-sm text-slate-900 dark:text-slate-100 outline-none placeholder:text-slate-500"
          />
          <Link to="/jobs">
...
function BentoGrid() {
  return (
    <div className="grid gap-4 md:grid-cols-3 md:auto-rows-[180px]">
      <Card className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-slate-100 dark:from-slate-900 to-slate-200 dark:to-slate-950 border-slate-300 dark:border-slate-800">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-slate-700 dark:text-slate-300">
            CV&apos;ni ve tercihlerini analiz ederek her ilan için
            kişiselleştirilmiş bir uyum yüzdesi hesaplıyoruz. Böylece &quot;%96
            uyumlu&quot; gibi etiketlerle zamanını en iyi fırsatlara
            ayırabiliyorsun.
          </p>
      ...
      <Card className="md:row-span-2 bg-slate-100 dark:bg-slate-900/60 border-slate-300 dark:border-slate-800">
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-base text-slate-900 dark:text-slate-50">
      ...
      <Card className="bg-slate-100 dark:bg-slate-900/60 border-slate-300 dark:border-slate-800">
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-base text-slate-900 dark:text-slate-50">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-slate-700 dark:text-slate-300">
            Favori ilanlarını kaydet, tek tıkla başvuru akışını başlat.
            Profilini tekrar tekrar doldurmak zorunda kalma.
          </p>
          <p className="text-xs text-slate-600 dark:text-slate-500">
